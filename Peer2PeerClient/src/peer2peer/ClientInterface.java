...
public interface ClientInterface extends java.rmi.Remote{
    ...
    public HashMap<String, ClientInterface> getAmigos() throws java.rmi.RemoteException;
    public void setAmigos(HashMap<String, ClientInterface> amigos) throws java.rmi.RemoteException;
